...
lst <- create_wordcloud(
  urls, 
  excludeWords = c("research", "archived", "stock", "wikipedia","also", "retrieved","can","informs","article","articles"), 
  max.words = 100)
lst$wcloud
...
* A short presentation of the course can be seen below
<div style="position: relative; padding-bottom: 56.25%; height: 0;"><iframe src="https://www.youtube.com/embed/FKK-IEM9RCI" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>
...
* Additional information about the course can found through the following [document](docs/Decision_Analysis_Introduction.pdf)
