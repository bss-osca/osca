...
lst <- create_wordcloud(
  ...
  excludeWords = c("research", "archived", "stock", "wikipedia","also", "retrieved","can","informs",
                   ...
                   "well", "list", "may", "focus", "treat", "use", "focuses"), 
  max.words = 100)
lst$wcloud
...
Moreover, in the 6'th semester you may write your bachelor thesis within topics such as operations management, supply chain management, business analytics, production planning, distribution and transportation, forecasting, scheduling, logistics, lean, balanced scorecard and many more. Have a look at the Operations and SCM section in the [supervisor list pdf](https://studerende.au.dk/studier/fagportaler/businessadm/bachelorprojekt-og-speciale/bachelorprojekt/). 



Finally, the [Operations and Supply Chain Analytics (OSCA)](https://kandidat.au.dk/operationsandsupplychainanalytics/) master study program provides you with advanced knowledge within broad areas of operations and supply chain management. The program will equip students with skills in designing and managing intra-firm operations activities such as production, inventory, distribution and transportation, as well as inter-firm activities in a coordinated supply chain. Those skills are enhanced further through the mastering of digital tools for analytics covering data management using VBA and R, optimization and heuristics, and simulation and business process modeling, which are used for transforming data into insights for making better decisions. Note that you do not have to follow any of the aforementioned electives for joining the [OSCA](osca.html) program.
...
[[Vestas](https://www.vestas.com/) | [BESTSELLER](https://about.bestseller.com/contact/general-contact) |
[Arla](https://www.arla.dk/om-arla/landmandsejet/) |
[iAdvice](https://www.iadvice.dk/?gclid=Cj0KCQjwgtWDBhDZARIsADEKwgMwhuI-B3umC8dVFm11A8Z5zAzZlsogkP_4Mlf7B3nSI4ETeY8ykpgaAlpDEALw_wcB) | 
...
[[official course description](`r str_c("https://kursuskatalog.au.dk/da?year=", year(now())-1, "-", year(now())+1, "&search=supply%20chain%20management%20and%20sustainability&department=46")`) | [additional information](assets/PresentationElectivesSCMS2021.pptx)]
...
[[official course description](`r str_c("https://kursuskatalog.au.dk/da?year=", year(now())-1, "-", year(now())+1, "&search=modellering%20inden%20for%20prescriptive%20analytics&department=46")`) | [introduction video](https://www.loom.com/embed/2f1a9f5a9f614b5481e57313621c8252)]
